...
cd $Qemuburo_install_dir"qemuburo/"; time python -m unittest Testqemuburo.qemuburoTestCase.test_t20jaflatstray>>/tmp/qemuburotestlog/logs

#ausgabe canal vom 2. ok
echo "ffffff" 
pwd
cd $tmpdir
   ls -l /tmp/qemuburotestlog/
cat /tmp/qemuburotestlog/logs
